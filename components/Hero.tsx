...
export default function Hero() {
  return (
    <section id="hero" className="relative h-dvh w-screen px-4">
      <GridBackground />
      <div className="h-full w-full flex items-center justify-center flex-col">
        ...
        <Link href="#">
          <HoverBorderGradient
            ...
            as="button"
            className="bg-blue-600 hover:bg-blue-500 flex items-center space-x-2 font-semibold cursor-pointer"
          >
            Start Absorbing
          </HoverBorderGradient>
        </Link>
